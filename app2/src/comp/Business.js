...
import { Businessnews} from '../Features/showSlice';

const Business = () => {
  const dispatch = useDispatch();

  useEffect(() => {
    dispatch(Businessnews()); // Dispatch the action when the component mounts
  ...
  return (
    <div  style={{backgroundImage:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRestsXgwFVzWNVJ2oHCTESpdQ5XrOx7sr77g&usqp=CAU"}}>
      ...
      <h1 style={{textAlign:"center"}}>BUSINESS NEWS</h1>
      <br></br>
